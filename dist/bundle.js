...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      var Com = (0, _AsyncComponent2.default)('./Dynamic/Dynamic.jsx');
...
exports.default = function (comPath) {
      ...
      value: function componentWillMount() {
        ...
        if (true) {
          Promise.resolve().then(function () {
            return __webpack_require__(10)("" + comPath);
          }).then(function (res) {
            _this2.setState({
              Comp: res.default
            });
          ...
          var Comp = require(comPath).default;
...
var _dynamic = __webpack_require__(5);
...
var Dynamic = function (_React$Component) {
  ...
  _createClass(Dynamic, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: _dynamic2.default.dy },
        _react2.default.createElement(
          'span',
          null,
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js??ref--1-1!./dynamic.css", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js??ref--1-1!./dynamic.css");
...
var map = {
	...
	"./App.jsx": 2,
	"./AsyncComponent": 3,
	"./AsyncComponent.jsx": 3,
	"./Dynamic/Dynamic": 4,
	"./Dynamic/Dynamic.jsx": 4,
	"./Dynamic/dynamic.css": 5,
	"./app.css": 8,
	"./render": 1,
	"./render.js": 1
};
...
// module
exports.push([module.i, ".dynamic---dy---1Hltu {\n  color: brown;\n}", ""]);
